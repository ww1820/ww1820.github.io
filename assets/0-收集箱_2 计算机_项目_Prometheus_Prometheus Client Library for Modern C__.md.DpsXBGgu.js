import{_ as n,o as a,c as p,a2 as l}from"./chunks/framework.Crpw6aS5.js";const m=JSON.parse('{"title":"Prometheus Client Library for Modern C++","description":"","frontmatter":{},"headers":[],"relativePath":"0-收集箱/2 计算机/项目/Prometheus/Prometheus Client Library for Modern C++.md","filePath":"0-收集箱/2 计算机/项目/Prometheus/Prometheus Client Library for Modern C++.md","lastUpdated":1786948858000}'),e={name:"0-收集箱/2 计算机/项目/Prometheus/Prometheus Client Library for Modern C++.md"};function i(r,s,t,c,u,b){return a(),p("div",null,[...s[0]||(s[0]=[l(`<h1 id="prometheus-client-library-for-modern-c" tabindex="-1">Prometheus Client Library for Modern C++ <a class="header-anchor" href="#prometheus-client-library-for-modern-c" aria-label="Permalink to &quot;Prometheus Client Library for Modern C++&quot;">​</a></h1> <p>#Prometheus</p> <p>项目链接：<a href="https://github.com/jupp0r/prometheus-cpp" target="_blank" rel="noreferrer">jupp0r/prometheus-cpp: Prometheus Client Library for Modern C++ (github.com)</a></p> <h2 id="简介" tabindex="-1">简介 <a class="header-anchor" href="#简介" aria-label="Permalink to &quot;简介&quot;">​</a></h2> <p>适用于现代 C++ 的 Prometheus 客户端库旨在实现 C++ 服务的Metric驱动开发。它实现了Promethues数据模型（Prometheus Data Model），可用于收集和暴露度量指标。</p> <h2 id="requirements" tabindex="-1">Requirements <a class="header-anchor" href="#requirements" aria-label="Permalink to &quot;Requirements&quot;">​</a></h2> <p>兼容 C++11 的编译器。</p> <h2 id="building" tabindex="-1">Building <a class="header-anchor" href="#building" aria-label="Permalink to &quot;Building&quot;">​</a></h2> <p><code>prometheus-cpp</code> 支持 CMake 和 bazel 两种构建方式，CMake 是使用 <code>prometheus-cpp</code> 是首选方式，因为三个 prometheus-cpp 库之间的所有依赖关系都能得到正确处理。</p> <p>cmake/project-import 目录包含一个示例项目和最小 CMakeLists.txt。</p> <div class="language-SHELL vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">SHELL</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># fetch third-party dependencies</span></span>
