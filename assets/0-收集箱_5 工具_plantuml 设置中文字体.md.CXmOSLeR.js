import{_ as s,o as a,c as p,a2 as e}from"./chunks/framework.Crpw6aS5.js";const u=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"0-收集箱/5 工具/plantuml 设置中文字体.md","filePath":"0-收集箱/5 工具/plantuml 设置中文字体.md","lastUpdated":1786948858000}'),l={name:"0-收集箱/5 工具/plantuml 设置中文字体.md"};function r(t,n,i,c,b,m){return a(),p("div",null,[...n[0]||(n[0]=[e(`<p>plantuml 中文字体</p> <div class="language-plaintext vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">plaintext</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>@startuml</span></span>
